...
export default function AdminSideBar() {
  return (
    <aside className="hidden md:flex md:flex-col w-56 shrink-0 h-screen sticky top-0 bg-white/60 py-6 px-3 overflow-y-auto">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                isActive ? "text-pink-500" : "text-gray-500 hover:bg-gray-50"
              }`
            }
          >
            {({ isActive }) => (
